        ...
        >
          ...
          <motion.div className="text-center mb-12" variants={fadeInUp}>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4">
              <span className="text-white">is this course </span>
          ...
          <motion.div
            className="max-w-6xl mx-auto rounded-3xl bg-[#10131a] backdrop-blur-lg border border-white/10 p-10 md:p-14"
            variants={fadeInUp}
          >
            <div className="grid md:grid-cols-2 gap-8 md:gap-12">
              {/* NOT For You Column - Red tint background */}
              <div className="rounded-2xl bg-gradient-to-br from-red-500/10 via-red-500/5 to-transparent p-6 md:p-8 border border-red-500/20">
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Skip this if...</h3>
                    <p className="text-base text-gray-400">Not the right fit</p>
                  </div>
                </div>
                <ul className="space-y-5">
                  {notForYouItems.map((item, index) => (
                    ...
                    >
                      ...
                      <span className="text-base text-gray-400 leading-relaxed group-hover:text-white transition-colors">
              ...
              <motion.div
                className="rounded-2xl bg-gradient-to-br from-green-500/10 via-green-500/5 to-transparent p-6 md:p-8 border border-green-500/20 shadow-lg shadow-green-500/5"
                initial={{ y: 0 }}
                whileHover={{ y: -4 }}
              ...
              >
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Perfect for you if...</h3>
                    <p className="text-base text-gray-400">Made for you</p>
                  </div>
                </div>
                <ul className="space-y-5">
