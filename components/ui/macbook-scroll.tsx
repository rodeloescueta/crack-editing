...
export function MacbookScroll({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-screen flex-shrink-0 origin-top scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 sm:origin-center md:min-h-[200vh] md:scale-100 md:py-80"
    >
      <motion.div
